    ...
    return (
        <div className="aut">
            ...
            <div className="aut-group">
                ...
                {!isLogin && <p className="aut-group-info">Пароль должен состоять из шести или более символов латинского алфавита. Содержать цифру, специальный символ, а также заглавную и строчную буквы.</p>}
